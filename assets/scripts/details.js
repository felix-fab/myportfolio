window.onload = function () {
    ...
    const detailPosts = {
        ...
        "0002": {
            ...
            imageSource: "./assets/images/details/stepahead-logo.webp",
            source: "https://www.stepahead.de/",
        ...
        "0003": {
            ...
            imageSource: "./assets/images/details/fachoberschule.webp",
            source: "https://www.konrad-zuse-schule.de/de/konradzuseschule",
        ...
        "0005": {
            ...
            imageSource: "./assets/images/details/stepahead-cloud.webp",
            source: "https://www.stepahead.de/",
            sourceTitle: "StepAhead GmbH"
        },
        "0006": {
            ...
            content: "<p>Während meiner Zeit an der <strong>Jahn-Schule</strong> in <strong>Hünfeld</strong> habe ich meinen <strong>Realschulabschluss</strong> erfolgreich absolviert. Schon früh in der Schulzeit entdeckte ich meine Leidenschaft für <strong>Technik</strong> und <strong>Programmierung</strong>. In den späteren Jahren setzte ich mich intensiv mit <strong>Computern</strong> und <strong>Softwareentwicklung</strong> auseinander, was meine Begeisterung für diesen Bereich weiter verstärkte. <br><br> Die Schulzeit bot mir eine solide Grundlage in den klassischen <strong>Fächern</strong> wie <strong>Mathematik</strong>, <strong>Deutsch</strong> und <strong>Englisch</strong>, die mir auch in meiner späteren Ausbildung und beruflichen Laufbahn zugutekamen. Besonders spannend war für mich jedoch der naturwissenschaftliche und technische Bereich, der mich motivierte, nach dem Realschulabschluss eine berufliche Richtung in der <strong>Informatik</strong> einzuschlagen. <br><br> Neben dem schulischen Lernen engagierte ich mich auch eigenständig in der <strong>Programmierung</strong>. In meiner Freizeit beschäftigte ich mich mit ersten <strong>Programmierprojekten</strong>, baute einfache <strong>Anwendungen</strong> und eignete mir Grundlagen in <strong>Programmiersprachen</strong> wie <strong>Java</strong> und <strong>Python</strong> an. Diese praktische Erfahrung war für mich der erste Schritt in eine berufliche Zukunft als <strong>Entwickler</strong>. <br><br> Die Zeit an der Jahn-Schule war daher nicht nur eine Phase der schulischen Entwicklung, sondern auch eine entscheidende Zeit, in der ich meinen beruflichen Fokus auf die <strong>Informatik</strong> richtete. Sie legte den <strong>Grundstein</strong> für meine spätere Ausbildung und Karriere als <strong>Fachinformatiker</strong>.</p>",	
            imageSource: "./assets/images/details/realschule.webp",
            source: "https://www.jahnschule-huenfeld.de/",
            sourceTitle: "Jahn-Schule Hünfeld"
        },
        "0007": {
            title: "WohnPilot",
        ...
        "0009": {
            ...
            imageSource: "./assets/images/details/nao-controller.webp"
        },
        "0010": {
            ...
            imageSource: "./assets/images/details/dark-animations-studio.webp"
        }
    };
    ...
    function showDetailPost() {
        ...
        if (detail) {
            ...
            if(detail.source){
                ...
                document.getElementById("detail-source").href = detail.source;
            }
